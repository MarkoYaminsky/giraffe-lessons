...
def string_multiplication(quantity: int):
...
def pretty_number(questionable_number: int) -> bool:
    ...
    is_pretty = (questionable_number % 7 == 0 or questionable_number % 17 == 0) and 999 < questionable_number < 9999
    return is_pretty
...
def rook_move(x1: int, y1: int, x2: int, y2: int):
    ...
    * Тура ходить по вертикалі та по горизонталі
    """
